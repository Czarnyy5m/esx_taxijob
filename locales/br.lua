Locales['br'] = {
  ...
  ['spawnpoint_blocked'] = 'há um veículo bloqueando o spawnpoint!',
  ...
  ['take_stock'] = 'Fazer um balanço',
  ['boss_actions'] = 'Ações do chefe',
  ['mission_complete'] = 'missão completada',
  ['quantity'] = 'quantidade',
  ['quantity_invalid'] = 'essa é uma quantidade inválida!',
